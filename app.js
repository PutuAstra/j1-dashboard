...
const App = (() => {
  ...
  const EDITABLE_FIELDS = {
    // Basic info
    gender:           { recruit: 'Gender',             crm: 'Gender',             type: 'select', options: ['Female','Male','Unspecified','—'] },
    ...
    department:       { recruit: 'Department',         crm: 'Department',         type: 'select', options: ['Agriculture','Art Gallery','Casino','Culinary','Deck & Engine','Education','Entertainment','Finance','Food & Beverage','Guest Relations','Housekeeping','Human Resources','Information Technology','Medical','Photo','Provisions & Inventory','Retail','Sales & Marketing','Sanitation','Security','Spa','Youth Staff','—'] },
    programSource:    { recruit: 'J1_Program_Sources', crm: 'J1_Program_Source',  type: 'select', options: ['CTI Bali','CTI Bangkok','CTI Indonesia','CTI MCSI','CTI USA','CTI Vietnam','Dhyana Pura Bali','Indiana School','Mediterranean Bali','OTC Bali','SITPRAM','Undiksha Bali','—'] },
    programType:      { recruit: 'Program_Option',     crm: 'Program_Option',     type: 'select', options: ['Full-Placement','Self-Placement','—'] },
    processingSponsor:{ recruit: 'Processing_Sponsor', crm: 'Processing_Sponsor', type: 'select', options: ['Alliance Abroad Group','CIEE','Green Heart','—'] },
    withdrawalReason: { recruit: 'Application_Withdrawal_Reason', crm: 'Application_Withdrawal_Reason', type: 'select', options: ['Documents Issues','Family Matter','Lack of Funding','Medical Reasons','Personal Matter','Pregnancy','Still Employed','Unresponsive Communication','—'] },
    ctiUsaReview:     { recruit: 'CTI_USA_s_Review',   crm: 'CTI_USA_s_Review',   type: 'select', options: ['Eligible for Consultation Call','Not Eligible for Consultation Call','—'] },
    placementStatus:  { recruit: 'J1_Application_Status', crm: 'J1_Application_Status', type: 'select', options: ['New Submission','Consultation Call','Sales Call','Stage 1','Stage 2','Stage 3','Stage 4','USA Onboard','Program Completed','On Hold','Archived Participants','Unqualified Participant','Withdraw at Consultation Call','Withdraw at Stage 1','Withdraw at Stage 2','Withdraw at Stage 3','Withdraw at Stage 4','—'] },
    // Consultation Call
    consultationCallStatus: { recruit: 'Consultation_Call_Status', crm: 'Consultation_Call_Status', type: 'select', options: ['Approved','Approved - Applied Position Unavailable','Approved - OTC Students','On Hold','On Hold - Requires English Improvement','Denied','—'] },
    consultationCallBy:     { recruit: 'Consultation_Call_Done_By',crm: 'Consultation_Call_Done_By',type: 'select', options: ['Eduardo Ferraz','Herry Wahyudi','Stri Ratna','—'] },
    ...
    proofAcademic:       { recruit: 'Proof_of_Academic_Status',     type: 'select', options: ['Need to Process','In Process','Valid','—'] },
    hcInterviewDate:     { recruit: 'HC_Interview_Date',            type: 'date' },
    hcInterviewStatus:   { recruit: 'Hosting_Company_Interview_Status', type: 'select', options: ['Approved','Declined','Pending','No Show','—'] },
    sponsorStatus:       { recruit: 'Sponsor_Interview_Status',     type: 'select', options: ['Approved','Declined','Pending','No Show','—'] },
    ...
    sponsorInvoiceStatus:{ recruit: 'Program_Sponsor_Invoice_Status', type: 'select', options: ['Paid to Sponsor','Invoice Pending','—'] },
    // Visa
    visaStatus:       { recruit: 'J1_Visa_Status',             type: 'select', options: ['Approved','Pending','Pending 2nd Interview','Pending 3rd Interview','Rejected 1st Attempt','Rejected 2nd Attempt','Rejected 3rd Attempt','—'] },
    refLetterStatus:  { recruit: 'Reference_Letter_Status',    type: 'select', options: ['Requested','In Process','Issued','—'] },
    ...
    // Travel outbound
    flightBooked:     { recruit: 'Flight_Ticket_Status',       type: 'select', options: ['Requested','Booked','Ticket Issued','—'] },
    airline:          { recruit: 'Airline',                    type: 'select', options: ['American Airlines','China Airlines','Delta Airlines','Emirates','Japan Airlines','Qatar Airways','Singapore Airlines','Turkish Airlines','United Airlines','—'] },
    ...
    airportGateway:   { recruit: 'Airport_Gateway',            type: 'select', options: ['DPS\tNgurah Rai International Airport (Denpasar, Bali)','CGK\tSoekarno–Hatta International Airport (Jakarta)','SUB\tJuanda International Airport (Surabaya)','DOH\tHamad International Airport (Doha, Qatar)','DXB\tDubai International Airport (Dubai, UAE)','PHL\tPhiladelphia International Airport (Pennsylvania)','MDT\tHarrisburg International Airport (Middletown, PA)','MIA\tMiami International Airport (Miami, Florida)','JFK\tJohn F. Kennedy International Airport (New York)','FLL\tFort Lauderdale–Hollywood International Airport','—'] },
    airportPickup:    { recruit: 'Airport_Pick_Up',            type: 'select', options: ['Provided by Host','Not Provided by Host','—'] },
    ticketPayStatus:  { recruit: 'Ticket_Payment_Status',      type: 'select', options: ['Awaiting for Payment','Paid','—'] },
    ticketPricing:    { recruit: 'Ticket_Pricing',             type: 'text' },
    // Return travel
    returnFlightStatus: { recruit: 'Returning_Flight_Ticket_Status', type: 'select', options: ['Requested','Booked','Ticket Issued','—'] },
    returnAirline:    { recruit: 'Returning_Airline',          type: 'select', options: ['American Airlines','China Airlines','Delta Airlines','Emirates','Japan Airlines','Qatar Airways','Singapore Airlines','Turkish Airlines','United Airlines','—'] },
    ...
    // Housing
    housingAvailability: { recruit: 'Housing_Availability',    type: 'select', options: ['Available Through Host','Available Through CTI','Arranged by Participant','—'] },
    housingLandlord:  { recruit: 'Housing_Landlord', crm: 'Housing_Landlord', type: 'select', options: ['RJ Management Colorado Inc. - Colorado Springs, CO','Delray Beach','Dominga P. Garcia - Miami, FL','Ely Diaz - Orlando, FL','Runako Kamau - Newark, NJ','Tatiana Restrepo - Miami, FL','Arranged by Participant','Provided by Host','—'] },
    ...
    // Host company
    hostCompany: { recruit: 'Hosting_Company_2', crm: 'Hosting_Company', type: 'select', options: ['—','6H Management LLC dba Albert Hotel','ACCOR Hotels - Fairmont Austin','ACCOR Hotels - Fairmont Pittsburgh','ACCOR Hotels - Fairmont Washington DC','Agora Bakery','Alinea Restaurant','Alliance Abroad Group Inc','Amorino Gelato at 50 John F Kennedy St','Anchorage By The Sea','Anchorage Marriott Downtown','Anglers Lodge','Application Process On Hold','Atlantis Casino Resort and Spa','Atoboy','AVA Coconut Grove','AVA MediterrAegean (Riviera Dining Group)','Backwater Bar LLC','Bahia Mar','Bar Harbor Regency','Bar Ni Ranch','Basin Harbor','Bay View Restaurant and Bar','Beaver Run Resort and Conference Center','Beavers Lessee LLC Sage The Nines','Beemok Hospitality Collection','Big Cedar','Big Cedar Lodge','Big Cypress Lodge','Biltmore Estate','Biltmore Hotel','Bluefin Bay  Family of Resorts','Boars Head Resort','Bowie House','Broken Sound Club','Busch Gardens - Williamsburg','Camden Harbour Inn','Carmel Valley Ranch','Casa Neos (Riviera Dining Group)','Castle Hill Resort and Spa','Central Valley Ag','CH Patisserie','Chateau Elan','Cheeca Lodge and Spa','CHG - The Iberian Pig - Buckhead GA','Chula Vista Resort','Claudio\'s Tabl','Country Inn and Suites by Radisson - Prairie du Chien','Crescent Hotels - Horseshoe Bay Resort','Crown Plaza Annapolis','Dania Pointe Partners LLC dba Marriott Ft Lauderdale Airport','Deer Valley Resort','DeFoor Hospitality Group - Chattanooga Marriott Downtown','Devil\'s Thumb Ranch','Driftwood Hospitality- Doubletree by Hilton Phoenix Tempe','Driftwood Inn','DSN Beach Club','Dusit Beach Resort Guam','Economos Properties - Fairfield Inn and Suites Ft Lauderdale','Economos Properties Inc-Hilton Garden Inn Ft Lauderdale','Economos Properties Inc-Homewood Suites by Hilton','Elk Avenue Hospitality','Enchantment Resort','EOS Hospitality- Hawks Cay Resort','EOS Hospitality-Isla Bella Beach Resort','Eurostars Langford','Eurostars Magnificent Mile','Eurostars St. Gregory','Eurostars Wall Street','Everhome Suites Cheyenne','Export Inc','FHR ML Operating Company LLC DBA The Fairmont Orchid Hawaii','Flora Bama - Coastal Orange Beach','Four Seasons Houston Centre Inc','Four Seasons Resort Lanai','Fresh Meadow Country Club','Full Service Hosp DoubleTree by Hilton Owatonna','Full Service Hospitality-The Arlington Resort Hotel and Spa','Gaylord Texan Resort and Convention Center','Glacier Bay\'s Bear Track Inn','Glacier International Lodge','Golden Host Resort','Grand Hyatt DFW Airport Hotel','Grand Hyatt Vail','Great Wolf Lodge - Bloomington','Great Wolf Lodge - Mason','Great Wolf Lodge - Traverse City','Great Wolf Lodge - Williamsburg','Great Wolf Lodge Wisconsin Dells','Green Hills Hilton','Gurney\'s Montauk Resort and Seawater Spa','Hampton by Hilton Bar Harbor','HEI - Doubletree by Hilton Hotel Austin','HEI DoubleTree by Hilton by Pittsburgh Cranberry','Hello Sono LLC','Hershey Entertainment & Resorts','Hershey Lodge','HHM Boston Harbor Hotel','Hilton Franklin Cool Springs','Hilton Guam Resort & Spa','Hilton Head Health - Weight Loss Resort and Health Spa','HMP - Comfort Inn Williamsburg Gateway','HMP - Holiday Inn and Suites Williamsburg - Historic Gateway','HMP - Holiday Inn Express and Suites Norfolk Airport','HMP - Holiday Inn Express Williamsburg Busch Gardens','HMP - Sparky Williamsburg LLC','Hotel Drover','Hotel Equities dba Kansas City Airport Marriott','Howard Hanna Real Estate Services','HP Palm Beach Investment LLP DBA PGA National Resort','HSG - Delta By Marriott Toledo','HSG - Marriott Knoxville Downtown','HSG - The Roslyn - Tapestry Collection by Hilton','HSG -Fairfield by Marriott Asheboro','HSG-The Palmer House Ascend Collection By Choice','Hufft Marchand Hospitality- BarCar','Hufft Marchand Hospitality- Il Supremo Pizza','Hyatt Regency Chesapeake Bay Golf Resort, Spa and Marina','Hyatt Regency DFW International Airport Hotel','Innis Arden Golf Club','Institute for Human Centered Design','Interlochen','IT INTERN (APPLICATION DEVELOPER) 2026','Ithaka Hospitality - Elevation Convening Center and Hotel','Ithaka Hospitality - The Hotel at Auburn University','J Benton Construction LLC','JW Marriott Austin','Kalahari Resort','Kalahari Resort - Pocono Mountains','Kalahari Resort - Wisconsin Dells','Kalahari Resort Round Rock TX','Kalahari Resort Sandusky OH','King Rose of NY Inc','Krishna IAH LLC DBA Holiday Inn IAH','La Quinta Resort','Lafayette USA - Miami','Lemongrass Delray Beach','Lemongrass Wellington, LLC','Lido Beach Resort','Lied Lodge at Arbor Day Farm','Limelight','Limelight Hotel Ketchum','Little Gem Resorts LLC- Lovango Resort  Beach Club','Lucy\'s Restaurant','Lutsen Mountains Ski','Makeready - Junto','Makeready - The Cliff House Maine','Margaritaville Hollywood Beach Resort- Davidson Hospitality','Marriott - Hyatt Windward Pointe','Marriott - Manor Club','Marriott - Sheraton Mountain Vista Villas','Marriott Int- The Ritz-Carlton Bachelor Gulch','Marriott International - The Gaylord Texan Hotel','Marriott Intl - Gaylord Opryland Resort Convention Center','Marriott Intl - The Ritz Carlton Fort Lauderdale','Marriott Intl- Gaylord Rockies Resort and Convention Center','Marriott Intl- JW Marriott Tucson Starr Pass Resort','Marriott Intl- Sawgrass Marriott Golf Resort and Spa','Marriott Intl- St Regis Aspen Resort','Marriott Intl- St Regis Bal Harbour','Marriott Intl-The Ritz - Carlton Reynolds Lake Oconee','Maxsa Innovations','Mcguire Moorman Hospitality- Word of Mouth Fine Catering','Mila (Riviera Dining Group)','MINTL - Orlando World Center Marriott','MINTL - Renaissance Dallas Hotel','MINTL - The Ritz Carlton Hotel Denver','MINTL- W Aspen','Miraval Austin Resort and Spa','Monarch Blackhawk Resort','Morey\'s Piers','Mountain View Grand Resort and Spa','Mt Olympus Water Park and Theme Park Resort','New Castle Hotels- Cherry Valley Hotel','New Castle Hotels- The Craftsman Inn','Next Restaurant','NightRide Thermal Inc.','Northern Hospitality Group 49th State Brewing Anchorage','Ocean Properties Hotels at The Resort at Longboat Key Club','Ocean Reef Club','Omni Dallas Hotel','Omni Hilton Head Oceanfront Resort','One and Only Moonlight Basin','Opal Key Resort and Marina','Orbifold AI at 220 Main Street','Palisades Tahoe','Palmas - San Angel Inn','Palmas - Springs Food Service at Disneys Coronado Springs','Palmas - Vista Springs at Disney Springs - Frontera Cocina','Park Hyatt Beaver Creek Resort and Spa','Pelham House Resort','Pembrooke & Ives','Polo Club of Boca Raton','PSC Bath','Pyramid Global Hospitality- Chatham Bars Inn','Pyramid Global Hospitality- The Equinox Resort and Spa','Pyramid Global Recruitment - Dellshire Resort','Rainbow of Love','Rassa','RBC Bearings Inc - Oxford CT','Red Sands Hotel and Spa','Riviera Dining Group','Riviera Dining Group - Ava Mediterraegean','Riviera Dining Group - Casa Neos','Riviera Dining Group - Claudie Restaurant','Riviera Dining Group - Mila Restaurant and Lounge','Roberlo','Ruby\'s Inn','Sage Hospitality - Hotel Alpenrock','Salt Wharf Restaurant and Bar','Sandpiper Hospitality  Quality Inn Tysons Corner','Sandpiper Hospitality Management LLC Candlewood Suites Hotel','Sandpiper Hospitality Management LLC Residence Inn Marriott','Sandpiper Hospitality- Arlington Court Suites','Sandpiper Hospitality- WoodSpring Suites Oak Ridge Knoxville','Saybrook Point Inn Marina and Spa','Sea Island','Sea Island Resort','Sea Pines Resort','Seabrook Island Club','Sexy Fish','Shaner Hotel Group - Buffalo Marriott at Lecom Harborcenter','Shore Lodge Whitetail Club','Sintel Hotel','Sonesta Resort Hilton Head Island','Sonoma Restaurant and Wine Bar','Spicy Zest LLC','Starr Restaurant Organization LP','STARR Restaurants - Talula\'s Garden','STARR Restaurants - The Love','Streamsong Resort','Sun Valley','Superior Shores Resort','SW Corp','Teleferic Barcelona','Teleferic Barcelona - Los Angeles','Teleferic Barcelona - Los Gatos','Teleferic Barcelona - Palo Alto','Teleferic Barcelona - Walnut Creek','The Abbey Resort','The Belle Haven Club','The Benjamin Royal Sonesta New York','The Blue Crab of Bethany Beach','The Broadmoor Hotel','The Burgundy Hotel, Tapestry Collection by Hilton','The Eliot Hotel','The Firebrand Hotel','The Georges Inn','The Kittansett Club','The Little America Hotel Cheyenne','The Lodge at Glendorn','The Lodge at Spruce Peak','The Lodge at Whitefish Lake','The Loren Austin','The Omni Homestead Resort','The Post Oak Hotel at Uptown Houston','The Powhatan Club','The Resort at Paws Up','The Ritz Carlton Club Aspen Highlands','The Royal Sonesta Chase Park Plaza','The Saint Hotel Key West','The Stanwich Club','The Treasury','The Westin Dallas Fort Worth Airport','Tides Inn','Ventana Big Sur','Viceroy Snowmass','Viewline Resort Snowmass','Waldorf Astoria Park City','Waterfront Hospitality Group','Waterfront Hotel','Westin Atlanta Perimeter','Westin Baltimore Washington','Westin Buckhead Atlanta','Westin Tampa Waterside','Westin Waltham Boston','White Lodging - Austin Marriott Downtown','White Lodging - Hotel Distil Louisville','White Lodging - Hyatt House Denver Downtown','White Lodging - JW Marriott Indianapolis','White Lodging - Kimpton Santo','White Lodging - Le Meridien and AC Hotel Denver Downtown','White Lodging - Marriott Louisville Downtown','White Lodging - Nashville Marriott at Vanderbilt University','White Lodging - The Otis Hotel and AC Hotel Austin','White Lodging - Westin Austin Downtown','White Lodging Services Inc - Main','Whitefish Mountain Resort','Wintergreen Resort at 39 Mountain Inn Loop','Wintergreen Resort Inc','Winvian Farm LLc','Woodmark Hotel and Still Spa','Woodspring Suites in Oak Ridge','Woodway Country Club','Xanterra Glacier National Park','Xanterra Parks & Resorts, Inc at The Grand Canyon South Rim','Xanterra Parks & Resorts, Inc at The Oasis Death Valley','Xanterra Yellowstone NP','XYZ Films','Yellowstone Club','YMCA of the Rockies'] },
